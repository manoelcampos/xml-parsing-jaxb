...
uma lista de produtos, a partir de https://raw.githubusercontent.com/manoelcampos/JavaXml2Lua/master/lua-sample-app/products.xml[products.xml]. Em seguida é instanciado um objeto link:src/main/java/com/manoelcampos/products/Products.java[Products.java]
