...
O projeto apresenta a classe link:src/main/java/XmlParser.java[XmlParser.java] que permite
...
uma lista de produtos, a partir de https://raw.githubusercontent.com/manoelcampos/JavaXml2Lua/master/lua-sample-app/products.xml[https://raw.githubusercontent.com/.../products.xml"]. Em seguida é instanciado um objeto link:src/main/java/com/manoelcampos/products/Products.java[Products.java]
